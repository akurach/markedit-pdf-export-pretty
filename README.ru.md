...
Расширение для [MarkEdit](https://markedit.app), экспортирующее текущий Markdown-документ в красиво отрендеренный PDF — заголовки, списки, таблицы, код, цитаты, ссылки и картинки, с поддержкой кириллицы. Не дамп сырого Markdown.
